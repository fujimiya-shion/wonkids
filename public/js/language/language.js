    ...
    constructor(locale) {
        ...
        this.dataSource = {
            'vi': {
                ...
                'phoneNotEntered': 'Chưa nhập số điện thoại',
                'phoneMustnotContainSpecialCharacter': 'Số điện thoại không được chứa ký tự đặc biệt',
                'loginNotEntered': 'Chưa nhập email hoặc số điện thoại',
                'loginNotValid': 'Email hoặc số điện thoại không hợp lệ',
            ...
            'en': {
                ...
                'loginNotEntered': 'Email or phone not entered',
                'loginNotValid': 'Email or phone is not valid',
            ...
            'ko': {
                ...
                'phoneNotEntered': '전화번호를 입력하지 않았습니다',
                'phoneMustnotContainSpecialCharacter': '전화번호에는 특수 문자를 포함할 수 없습니다',
                'loginNotEntered': '이메일 또는 전화번호를 입력하지 않았습니다',
                'loginNotValid': '이메일 또는 전화번호가 유효하지 않습니다',
